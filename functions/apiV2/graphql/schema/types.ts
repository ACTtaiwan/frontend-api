...
export default mergeTypes([bill, action, billType, billTextDocument, billTextVersion, billTracker, billSummary, tag, article, map, member, profilePicture, congressRole]);
